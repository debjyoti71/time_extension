...
- **Multi-Instance Coordination**: Coordinates active leases across multiple VS Code/Antigravity windows via `active_session.json` and atomic OS mutex `data.json.lock` with auto-stale recovery.
